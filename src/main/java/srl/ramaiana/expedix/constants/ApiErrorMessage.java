...
public enum ApiErrorMessage {
    ...
    SHOP_NOT_FOUND("Shop: %s not found"),
    PRODUCT_NOT_FOUND("Product: %s not found"),
    PRODUCT_NOT_ENOUGH_STOCK("Product: %s not found"),
    SETTLEMENT_ALREADY_EXISTS("Settlement: %s already exists"),
    USER_NOT_FOUND("User: %s not found"),
    SETTLEMENT_NOT_FOUND("Setting: %s not found"),
